        ...
        if cur.fetchone()[0] == 0:
            defaults = [
                ("산업안전보건교육", "quarter", 6.0, "all", 1, "분기별 6시간 (사무직 3시간)",
                 "산업재해 예방을 위해 안전보건 지식과 의식을 높이는 교육입니다. 기계·화학·추락 등 사고 위험 감소와 안전한 작업 환경 조성이 목적입니다.|산업안전보건법 제29조|미실시 시 500만원 이하 과태료 (제175조) — 상시근로자 1인 이상 전 사업장 의무"),
                ("성희롱 예방교육", "year", 1.0, "all", 1, "연 1회 이상",
                 "직장 내 성희롱 발생을 예방하고 피해자 보호·구제 방법을 알리는 교육입니다. 건강한 직장 문화 조성과 사건 발생 시 대처 절차 숙지가 목적입니다.|남녀고용평등법 제13조|미실시 시 500만원 이하 과태료 (제39조) — 전 사업장 연 1회 이상 의무"),
                ("개인정보보호교육", "year", 1.0, "all", 1, "연 1회 이상",
                 "업무 중 취급하는 고객·직원 개인정보를 안전하게 관리하도록 하는 교육입니다. 정보 유출·오남용 방지와 개인정보보호법 준수가 목적입니다.|개인정보보호법 제28조|미실시·관리 소홀 시 최대 3,000만원 이하 과태료 (제75조) — 개인정보 취급자 전원 대상"),
                ("소방훈련/교육", "half", 1.0, "all", 1, "연 2회 이상",
                 "화재 발생 시 신속한 대피·초기진화 능력을 갖추기 위한 실습 중심 교육입니다. 소화기·옥내소화전 사용법, 피난 경로 숙지, 비상연락 체계 확인이 목적입니다.|화재예방법 제37조|미실시 시 200만원 이하 과태료 (제52조) — 상시 10인 이상 사업장 연 2회 이상 의무"),
                ("직장 내 장애인 인식개선교육", "year", 1.0, "all", 1, "연 1회 이상",
                 "장애인에 대한 편견을 해소하고 장애인 근로자와 원활하게 협업하는 환경을 만들기 위한 교육입니다. 장애 유형별 이해, 차별 금지, 편의 제공 방법 습득이 목적입니다.|장애인고용촉진법 제5조의2|미실시 시 300만원 이하 과태료 (제86조) — 상시 1인 이상 전 사업장 연 1회 의무"),
                ("퇴직연금교육", "year", 1.0, "all", 1, "연 1회 이상",
                 "퇴직연금 제도의 구조·운용·수익률을 이해하고 근로자 스스로 노후 자산을 관리할 수 있도록 돕는 교육입니다. DC형 가입자는 투자 성향에 맞는 운용지시 능력 향상이 목적입니다.|근로자퇴직급여보장법 제32조|미실시 시 1,000만원 이하 과태료 (제48조) — 퇴직연금 가입 사업장 연 1회 의무"),
                ("직장 내 괴롭힘 예방교육", "year", 1.0, "all", 1, "연 1회 이상",
                 "직장 내 괴롭힘(갑질·따돌림·모욕 등)의 개념과 예방법, 피해 시 신고·처리 절차를 안내하는 교육입니다. 심리적으로 안전한 조직 문화 조성과 2차 피해 방지가 목적입니다.|근로기준법 제76조의3|직접 과태료 조항은 없으나 예방 의무 위반 시 손해배상 책임 발생 가능 — 취업규칙 기재 의무"),
            ]
            for d in defaults:
            ...
            penalties = {
                "산업안전보건교육":
                    "산업재해 예방을 위해 안전보건 지식과 의식을 높이는 교육입니다. 기계·화학·추락 등 사고 위험 감소와 안전한 작업 환경 조성이 목적입니다."
                    "|산업안전보건법 제29조"
                    "|미실시 시 500만원 이하 과태료 (제175조) — 상시근로자 1인 이상 전 사업장 의무",
                "성희롱 예방교육":
                    "직장 내 성희롱 발생을 예방하고 피해자 보호·구제 방법을 알리는 교육입니다. 건강한 직장 문화 조성과 사건 발생 시 대처 절차 숙지가 목적입니다."
                    "|남녀고용평등법 제13조"
                    "|미실시 시 500만원 이하 과태료 (제39조) — 전 사업장 연 1회 이상 의무",
                "개인정보보호교육":
                    "업무 중 취급하는 고객·직원 개인정보를 안전하게 관리하도록 하는 교육입니다. 정보 유출·오남용 방지와 개인정보보호법 준수가 목적입니다."
                    "|개인정보보호법 제28조"
                    "|미실시·관리 소홀 시 최대 3,000만원 이하 과태료 (제75조) — 개인정보 취급자 전원 대상",
                "소방훈련/교육":
                    "화재 발생 시 신속한 대피·초기진화 능력을 갖추기 위한 실습 중심 교육입니다. 소화기·옥내소화전 사용법, 피난 경로 숙지, 비상연락 체계 확인이 목적입니다."
                    "|화재예방법 제37조"
                    "|미실시 시 200만원 이하 과태료 (제52조) — 상시 10인 이상 사업장 연 2회 이상 의무",
                "직장 내 장애인 인식개선교육":
                    "장애인에 대한 편견을 해소하고 장애인 근로자와 원활하게 협업하는 환경을 만들기 위한 교육입니다. 장애 유형별 이해, 차별 금지, 편의 제공 방법 습득이 목적입니다."
                    "|장애인고용촉진법 제5조의2"
                    "|미실시 시 300만원 이하 과태료 (제86조) — 상시 1인 이상 전 사업장 연 1회 의무",
                "퇴직연금교육":
                    "퇴직연금 제도의 구조·운용·수익률을 이해하고 근로자 스스로 노후 자산을 관리할 수 있도록 돕는 교육입니다. DC형 가입자는 투자 성향에 맞는 운용지시 능력 향상이 목적입니다."
                    "|근로자퇴직급여보장법 제32조"
                    "|미실시 시 1,000만원 이하 과태료 (제48조) — 퇴직연금 가입 사업장 연 1회 의무",
                "직장 내 괴롭힘 예방교육":
                    "직장 내 괴롭힘(갑질·따돌림·모욕 등)의 개념과 예방법, 피해 시 신고·처리 절차를 안내하는 교육입니다. 심리적으로 안전한 조직 문화 조성과 2차 피해 방지가 목적입니다."
                    "|근로기준법 제76조의3"
                    "|직접 과태료 조항은 없으나 예방 의무 위반 시 손해배상 책임 발생 가능 — 취업규칙 기재 의무",
            }
