...
def build_values(cur, emp_no, yy, resid_id=""):
    ...
    if "73tax" in _erp:
        r[72] = _erp["73tax"]
    # 64.기부금 계열은 ERP 만 믿는다. ERP 가 항목을 안 준 사람은 공제가 적용되지
    # 않은 것이므로 빈칸이어야 한다. 계산기 값을 남겨두면 김미선처럼 발급본은
    # 빈칸인데 우리만 1,500 을 찍는다.
    for _k in ("64pol_lo", "64pol_lo_obj", "64pol_hi", "64pol_hi_obj",
