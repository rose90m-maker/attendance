...
const st = (e) => ({ url: e.src || void 0 }), zi = {
  ...
  return n.className = "bn-visual-media", t.resolveFileUrl ? t.resolveFileUrl(e.props.url).then((r) => {
    n.src = r;
  }) : n.src = e.props.url, n.alt = e.props.name || e.props.caption || "BlockNote image", n.contentEditable = "false", n.draggable = !1, i.appendChild(n), Ot(
    e,
    t,
    { dom: i },
    i,
  ...
  return n.className = "bn-visual-media", t.resolveFileUrl ? t.resolveFileUrl(e.props.url).then((r) => {
    n.src = r;
  }) : n.src = e.props.url, n.controls = !0, n.contentEditable = "false", n.draggable = !1, n.width = e.props.previewWidth, i.appendChild(n), Ot(
    e,
    t,
    { dom: i },
    i,
...
function Ke(e) {
  ...
  return t.unified.unified().use(t.rehypeParse.default, { fragment: !0 }).use(rr).use(ar).use(t.rehypeRemark.default).use(t.remarkGfm.default).use(t.remarkStringify.default, {
...
const ht = (e, t) => {
  ...
  return t;
}, Tr = (e, t) => e.isBlockContainer && e.blockContent.node.type.spec.content === "inline*" && e.blockContent.node.childCount > 0 && t.isBlockContainer && t.blockContent.node.type.spec.content === "inline*", Mr = (e, t, o, i) => {
  if (!i.isBlockContainer)
    throw new Error(
    ...
    return {
      Backspace: () => this.editor.commands.first(({ chain: i, commands: n }) => [
        ...
        () => n.command(({ state: r, dispatch: a }) => {
          ...
          const m = u.childContainer.node.childCount === 1, f = m && h.childContainer.node.childCount === 2, g = h.childContainer.node.firstChild === u.bnBlock.node;
          if (a) {
            const b = r.doc.slice(
              s.bnBlock.beforePos,
              s.bnBlock.afterPos,
...
const Nr = [
  ...
  "cid",
  "xmpp"
], jr = "https", Dr = new N("node-selection-keyboard");
class Hr {
  constructor() {
    p(this, "plugin");
    this.plugin = new B({
...
const Ur = new N("blocknote-placeholder");
class Or {
  constructor(t, o) {
    p(this, "plugin");
    this.plugin = new B({
  ...
  constructor(t, o, i) {
    ...
    p(this, "updateStateFromMousePos", () => {
      ...
      if (this.menuFrozen || !this.mousePos)
        return;
      const t = Gr(this.mousePos, this.pmView);
    ...
    p(this, "onDrop", (t) => {
      var i;
      if (this.editor._tiptapEditor.commands.blur(), t.synthetic || !((i = t.dataTransfer) != null && i.types.includes("blocknote/html")))
        return;
    ...
    p(this, "onDragOver", (t) => {
      var i;
      if (t.synthetic || !((i = t.dataTransfer) != null && i.types.includes("blocknote/html")))
        return;
      const o = this.pmView.posAtCoords({
        left: t.clientX,
        top: t.clientY
...
class ea {
  constructor(t, o, i) {
    ...
    p(this, "mouseMoveHandler", (t) => {
      ...
      if (Un("table", s, this.editor) && (this.tablePos = a.posBeforeNode + 1, r = s), !r)
        return;
      this.tableId = n.id;
      ...
      if ((o == null ? void 0 : o.type) === "wrapper") {
        const m = t.clientY >= i.bottom - 1 && // -1 to account for fractions of pixels in "bottom"
        ...
        this.state = {
          show: !0,
          showAddOrRemoveColumnsButton: m === r.content.rows[0].cells.length - 1,
    ...
    p(this, "dragOverHandler", (t) => {
      ...
      if (((h = this.state) == null ? void 0 : h.draggingState) === void 0)
        return;
      t.preventDefault(), t.dataTransfer.dropEffect = "move", Qr(
...
const oa = I.create({
  ...
  t.formattingToolbar = new Br(
    e.editor
  ), t.linkToolbar = new Ar(e.editor), t.sideMenu = new Kr(e.editor), t.suggestionMenus = new Zr(e.editor), t.filePanel = new Cr(e.editor), t.placeholder = new Or(e.editor, e.placeholders), (e.animations ?? !0) && (t.animations = new Vr()), e.tableHandles && (t.tableHandles = new ta(e.editor)), t.dropCursor = {
    plugin: e.dropCursor({
      width: 5,
      color: "#ddeeff",
      editor: e.editor
...
export {
  ...
  $r as SideMenuView,
  Zr as SuggestionMenuProseMirrorPlugin,
  ta as TableHandlesProsemirrorPlugin,
  ea as TableHandlesView,
  ue as UniqueID,
